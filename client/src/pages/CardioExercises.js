...
const CardioExercises = () => {
  ...
  const workoutsCollectionRef = collection(db, "workouts/Cardio Exercises/Cardio collection") //name of the collection we want to map through
  const workoutsDocRef = doc(db, "workouts/Cardio Exercises")
  useEffect(() => {
